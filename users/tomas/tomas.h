...
#define SPLIT_NAV_LAYER(APPLY) APPLY(                                                                 \
    XXXXXXX ,QK_REP  ,SW_PTAB ,SW_NTAB ,CW_TOGG ,        KC_HOME ,KC_PGDN ,KC_PGUP ,TR_JMPF ,TR_JMPB ,\
    OS_LALT ,OS_LGUI ,OS_LCTL ,OS_LSFT ,TR_COPY ,        KC_LEFT ,KC_DOWN ,KC_UP   ,KC_RGHT ,XXXXXXX ,\
    TR_EMOJ ,SW_WIN  ,SW_APP  ,TR_TMUX ,TR_PAST ,        KC_END  ,KC_TAB  ,XXXXXXX ,TR_WCTR ,TR_WGRW ,\
                                        _______ ,        NUM_ENT                                      \
)
